...
public class ProfileManagerTest {
    ...
    public void setup()
    {
        ...
        Profile profile=new Profile("тест","test@email.com");
    ...
    {
        Profile profile = new Profile("админ","Admin@myumanitoba.ca");
        ProfileManager.addToProfileStorage(profile);
    ...
    {
        assertEquals(ProfileManager.getProfileStorage().getName(),"тест");
    }
