...
public class DetailActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener{
    ...
    private final int DCI = 66; // Зарегистрированные дни
    private int days = 0;
    Habit habit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getExtras() != null){
            int index = (int) getIntent().getSerializableExtra("индекс");
            ...
            System.out.println("ОШИБКА: Объект привычки не был передан в подробное представление.");
        }
    ...
    public void increaseCheckIn(){
        if (habit.getDaysCheckedIn() < DCI){
            if (habit.getDaysCheckedIn() < days) {
                ...
                Toast.makeText(this,"Достигнут максимальный уровень регистрации за эти дни!",Toast.LENGTH_SHORT).show();
            }
        }
    }
